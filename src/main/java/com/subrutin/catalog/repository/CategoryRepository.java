...
public interface CategoryRepository extends JpaRepository<Category, String> {
	...
	@Query("SELECT new com.subrutin.catalog.dto"
			+ ".CategoryQueryDTO(b.id, bc.code) "
			+ "FROM Book b "
			+ "JOIN b.categories bc WHERE b.id IN :idList")
	public List<CategoryQueryDTO> findCategoryByBookIdIn(List<Long> idList);
